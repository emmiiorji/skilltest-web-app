...
export class InitialMigration1748277581565 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`focus_lost_events\` \`focus_lost_events\` json NOT NULL DEFAULT ('[]')`);
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`clipboard_events\` \`clipboard_events\` json NOT NULL DEFAULT ('[]')`);
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`pre_submit_delay\` \`pre_submit_delay\` float NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`answer_change_events\` \`answer_change_events\` json NOT NULL DEFAULT ('[]')`);
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`device_fingerprint\` \`device_fingerprint\` json NOT NULL DEFAULT ('{}')`);
        ...
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`mouse_click_events\` \`mouse_click_events\` json NOT NULL DEFAULT ('[]')`);
        await queryRunner.query(`ALTER TABLE \`answers\` CHANGE \`keyboard_press_events\` \`keyboard_press_events\` json NOT NULL DEFAULT ('[]')`);
        await queryRunner.query(`ALTER TABLE \`tests\` CHANGE \`tracking_config\` \`tracking_config\` json NOT NULL DEFAULT ('{}')`);
    }
