...
export class InitialMigration1748277581565 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`answers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`test_id\` int NOT NULL, \`question_id\` int NOT NULL, \`profile_id\` int NOT NULL, \`answer\` text NOT NULL, \`user_agent\` varchar(255) NOT NULL, \`ip\` varchar(45) NOT NULL, \`time_taken\` int NOT NULL, \`copy_count\` int NOT NULL, \`paste_count\` int NOT NULL, \`right_click_count\` int NOT NULL, \`inactive_time\` int NOT NULL, \`is_correct\` tinyint NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`focus_lost_events\` json NOT NULL DEFAULT ('[]'), \`clipboard_events\` json NOT NULL DEFAULT ('[]'), \`pre_submit_delay\` float NOT NULL DEFAULT '0', \`answer_change_events\` json NOT NULL DEFAULT ('[]'), \`device_fingerprint\` json NOT NULL DEFAULT ('{}'), \`device_type\` varchar(10) NOT NULL DEFAULT 'desktop', \`time_to_first_interaction\` float NOT NULL DEFAULT '0', \`mouse_click_events\` json NOT NULL DEFAULT ('[]'), \`keyboard_press_events\` json NOT NULL DEFAULT ('[]'), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`questions\` (\`id\` int NOT NULL AUTO_INCREMENT, \`question\` text NOT NULL, \`answer_type\` enum ('textarea', 'radiobutton', 'multiinput', 'multiTextInput') NOT NULL, \`answer_html\` text NOT NULL, \`correct\` text NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`questions_tests\` (\`question_id\` int NOT NULL, \`test_id\` int NOT NULL, \`priority\` int NOT NULL, PRIMARY KEY (\`question_id\`, \`test_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`tests\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(255) NOT NULL, \`tracking_config\` json NOT NULL DEFAULT ('{}'), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`groups\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`profile\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`link\` varchar(255) NOT NULL, \`url\` varchar(255) NULL, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NULL, \`country\` varchar(255) NULL, \`title\` varchar(255) NULL, \`description\` text NULL, \`lastActivity\` datetime NULL, \`earned\` decimal(10,2) NULL, \`rate\` decimal(5,2) NULL, \`totalHours\` int NULL, \`inProgress\` tinyint NULL, \`invitedAt\` datetime NULL, \`shortname\` varchar(100) NULL, \`recno\` int NULL, \`agencies\` text NULL, \`totalRevenue\` decimal(10,2) NULL, \`memberSince\` datetime NULL, \`vanityUrl\` varchar(255) NULL, \`skills\` text NULL, \`process\` text NULL, UNIQUE INDEX \`IDX_06bd69d723b1cdda96abfe88a7\` (\`link\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`links\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`tag_id\` int NULL, \`link\` varchar(1000) NULL, \`active\` tinyint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`tags\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`profile_tags\` (\`profile_id\` int NOT NULL, \`tag_id\` int NOT NULL, PRIMARY KEY (\`profile_id\`, \`tag_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`templates\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`template\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`queries\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`query\` varchar(1000) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`tests_profiles\` (\`testId\` int NOT NULL, \`profileId\` int NOT NULL, INDEX \`IDX_7a1140d1305170d722dce3db2e\` (\`testId\`), INDEX \`IDX_391cab40370a0a8532b908dddf\` (\`profileId\`), PRIMARY KEY (\`testId\`, \`profileId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`tests_groups\` (\`testId\` int NOT NULL, \`groupId\` int NOT NULL, INDEX \`IDX_9413a2a7e0e2a7b3ba48ba3130\` (\`testId\`), INDEX \`IDX_fe025b9206a723938c35d70f1b\` (\`groupId\`), PRIMARY KEY (\`testId\`, \`groupId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS \`profiles_groups\` (\`profileId\` int NOT NULL, \`groupId\` int NOT NULL, INDEX \`IDX_536cca102bd5ef9f2be781d90c\` (\`profileId\`), INDEX \`IDX_89bc9bdd21ddd7e8bb160de163\` (\`groupId\`), PRIMARY KEY (\`profileId\`, \`groupId\`)) ENGINE=InnoDB`);
